...
function renderTasks(tasks) {
  ...
  const toDoString = tasks.map(taskTemplate).join("");
...
function newTask() {
  ...
  // render out the list
  let userInputValue = document.getElementById("todo").value;
  tasks.push({detail: userInputValue, completed: false});
  renderTasks(tasks);
...
button = document.querySelector("#submitTask")
