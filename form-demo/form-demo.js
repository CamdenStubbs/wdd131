function validateForm(event) {
  ...
  console.log(theForm.creditCardNumber.value)
  console.log(theForm.fullName.value)
  ...
  function togglePaymentDetails(e) {
    ...
    if (creditCardContainer.classList.value != "hide")
    {
      creditCardContainer.classList.add("hide");
    }

    if (paypalContainer.classList.value != "hide")
    {
